...
1. On the **Three ways to make a flow** page, scroll down on the landing page until you see **Start from connector**, and then select **SharePoint**.
...
1. On the left-hand navigation pane, select **My flows**.
